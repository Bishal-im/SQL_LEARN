...
- **Phase 4:** UNIONS practice
- **Phase 5:** String Functions (`SUBSTRING`, `REPLACE`, `LOCATE`)
- **Phase 6:** CASE statements & Subqueries
- **Phase 7:** Window Functions
- **Phase 8:** CTEs (Single & Multiple) and Temporary Tables
